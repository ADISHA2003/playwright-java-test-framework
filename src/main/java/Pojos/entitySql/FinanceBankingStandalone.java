...
@Data
@Entity
@Table(name = "finance_banking_standalone")
public class FinanceBankingStandalone {
    ...
    private Double equityShareDevidend;
    ...
    @Column(name = "equity_devidend_rate")
    private Double equityDevidendRate;
