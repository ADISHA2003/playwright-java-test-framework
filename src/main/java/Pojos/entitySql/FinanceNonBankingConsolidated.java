...
@Data
@Entity
@Table(name = "finance_non_banking_consolidated")
public class FinanceNonBankingConsolidated {
    ...
    @Column(name = "group_share_in_joint_ventures_in_income")
    private Double groupShareInJointVenturesInIncome;
    ...
    @Column(name = "group_share_in_joint_ventures_in_expenditure")
    private Double groupShareInJointVenturesInExpenditure;
    ...
    @Column(name = "share_of_profit_Loss_of_associates")
    private Double shareOfProfitLossOfAssociates;

    @Column(name = "profit_loss_after_mi_and_associates")
    private Double profitLossAfterMiAndAssociates;
    ...
    @Column(name = "pref_shares_issued_by_subsidiary_cos")
    private Double prefSharesIssuedBySubsidiaryCos;
    ...
    @Column(name = "goodwill_on_consolidation")
    private Double goodwillOnConsolidation;
