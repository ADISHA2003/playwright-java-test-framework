...
public class FinancialReports {
    ...
    @Column(name = "financial_reports_id")
    private Integer financialReportsId;
    ...
    @Column(name = "adjusted_pbdit", nullable = true)
    private Double adjustedPbdit;

    @Column(name = "financial_expences")
    private Double financialExpences;
    ...
    private Double proposedPrefDivdnd;
    ...
    private Double sparesStoresConsmption;
    ...
    private Double plOnSaleOfInvstmts;
    ...
    @Column(name = "inv_india")
    private Double invIndia;
    ...
    @Column(name = "corporate_dividend_tax")
    private Double corporateDividendTax;
