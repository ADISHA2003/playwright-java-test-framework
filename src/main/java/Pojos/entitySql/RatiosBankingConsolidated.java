...
@Data
@Entity
@Table(name = "ratios_banking_consolidated")
public class RatiosBankingConsolidated {
    ...
    @Column(name = "np_after_mi_per_employee")
    private Double npAfterMiPerEmployee;
    ...
    @Column(name = "np_after_mi_per_branche")
    private Double npAfterMiPerBranche;
    ...
    @Column(name = "npm_after_mi")
    private Double npmAfterMi;
