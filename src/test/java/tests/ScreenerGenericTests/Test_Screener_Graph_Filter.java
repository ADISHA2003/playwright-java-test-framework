...
public class Test_Screener_Graph_Filter extends BaseUI_Test {

    @Test(description = "As a user i view the results as non zero of every graph filter on filter and data table page along with values in linked tabs",dataProviderClass = utils.ScreenerJsonDataProvider.class,dataProvider = "getGraphFilters",groups = {"regression"})
    public void verifyUserApplyGraphFilterAndNavigatesToDataTable(String screenerName,String groupName,String subgroupName,String category,String subCategory,String filterName,String currentFilterType,Boolean isDefault,String api,String filterAPIReference){
        int position=0;
        ...
        ff.addFilterGraphInputValue(fms.getRangeOfInputValuesGraph(response));
