...
public class Test_Screener_Graph_Financial_Filter extends BaseUI_Test {

    @Test(description = "As a user i view the results as non zero of every graph filter on filter and data table page along with values in linked tabs",dataProviderClass = utils.ScreenerJsonDataProvider.class,dataProvider = "getGraphFinancialFilters",groups = "regression")
