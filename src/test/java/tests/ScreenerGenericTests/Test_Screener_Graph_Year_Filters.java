...
public class Test_Screener_Graph_Year_Filters extends BaseUI_Test {

    @Test(description = "As a user i view the results as non zero of every graph filter on filter and data table page along with values in linked tabs",dataProviderClass = utils.ScreenerJsonDataProvider.class,dataProvider = "getGraphYearFilters",groups = {"regression"})
    public void verifyUserApplyGraphYearFilterAndNavigatesToDataTable(String screenerName,String groupName,String subgroupName,String category,String subCategory,String filterName,String currentFilterType,Boolean isDefault,String api,String filterAPIReference){
        int position=0;
        ...
        ff.addFilterGraphInputValue(fms.getRangeOfInputValuesGraphYear(response));
